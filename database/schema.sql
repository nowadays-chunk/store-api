-- ============================================
-- MySQL 8 Database Schema for Tailored Bridge Store
-- Generated from Sequelize Models
-- ============================================

-- Drop database if exists and create fresh
DROP DATABASE IF EXISTS tailored_bridge_store_db;
CREATE DATABASE tailored_bridge_store_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE tailored_bridge_store_db;
